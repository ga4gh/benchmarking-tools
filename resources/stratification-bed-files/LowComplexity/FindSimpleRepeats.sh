...
/Applications/bioinfo/tabix-0.2.6/bgzip -c /Volumes/SSD960/references/findSimpleRegions/SimpleRepeat_p11.bed > /Volumes/SSD960/references/findSimpleRegions/SimpleRepeat_homopolymer_gt10.bed.gz
