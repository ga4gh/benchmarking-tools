...
# Version History
Changes in v3.3:
Enable use of phased calls and phase IDâ€™s from GATK-HC and output these in GT and PID when possible for locally phased variants
...
Now annotate vcf with â€œcallableâ€ regions from each callset instead of the regions that are not callable, which were previously annotated as â€œlowcovâ€
